    ...
    return (
        <div className="flex flex-col px-6 sm:px-10 md:px-20 py-10 max-w-6xl mx-auto">
            ...
            <div className="space-y-6 text-gray-700 leading-relaxed">
                ...
                <p className="text-base md:text-lg">
                    Beyond academics, I'm involved in my campus community. As an active member of Sigma Phi Epsilon (ΣΦΕ), my fraternity, I've developed strong leadership and teamwork skills. I've served as an Undergraduate Teaching Assistant for CS 3114 (Data Structures and Algorithms) and worked as an Undergraduate Research Assistant in Virginia Tech's Human-Computer Interaction lab, where I led a team of students in developing a mobile application for Appalachian Trail hikers. Additionally, I interned at the Republican National Committee as a Technology Intern, where I contributed to developing an internal full-stack web application using Python Django.
                </p>
                <p className="text-base md:text-lg">
